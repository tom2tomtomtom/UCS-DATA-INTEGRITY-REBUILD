...
7. `docs/SOURCE_CONTRACTS.md`
8. `docs/WHAT_NOT_TO_REPEAT.md`
9. `docs/ACCEPTANCE_GATES.md`
10. `docs/BUILD_PHASES.md`
11. `docs/IN_DASH_DATA_INTEGRITY_TESTS.md`
12. `docs/CLIENT_REQUIREMENTS_CAPTURE.md`
13. `docs/LAW_TEST_MATRIX.md`
14. `docs/UI_SCREENSHOT_REFERENCE_PLAN.md`
15. `docs/IDENTITY_MATCHING_POLICY.md`
16. `docs/TOLERANCE_UNITS_AND_TIME_POLICY.md`
17. `docs/SOURCE_STALENESS_AND_DELETION_POLICY.md`
18. `docs/FIXTURE_AND_GOLDEN_DATA_STRATEGY.md`
19. `docs/WARNING_LIFECYCLE_POLICY.md`
20. `docs/SECURITY_PERMISSIONS_AND_MUTATION_BOUNDARY.md`
21. `docs/LEGACY_DECOMMISSION_PLAN.md`
22. `docs/ENV_AND_SUPABASE_STRATEGY.md`
23. `docs/RAILWAY_DEPLOYMENT_STRATEGY.md`
24. `docs/CHAT_INVESTIGATION_AGENT_SPEC.md`
25. `docs/GO_NO_GO_READINESS.md`
26. `docs/BAD_CODE_UNRAVELLING_POLICY.md`
27. `docs/adr/0002-rebuild-start-decisions.md`
